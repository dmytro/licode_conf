...
//Use undefined to run clients without Stun 
config.erizoController.stunServerUrl = 'stun:ssd.mentorstudents.org:3478'; // default value: 'stun:stun.l.google.com:19302'
...
config.erizoController.hostname = 'd.mentorstudents.org'; //default value: ''
config.erizoController.port = 3004; //default value: 8080
...
config.erizoController.turnServer.url = 'turn:d.mentorstudents.org:3478'; // default value: null
config.erizoController.turnServer.username = 'talkvalley'; // default value: null
config.erizoController.turnServer.password = 'mentorstudents'; // default value: null
...
config.erizoController.recording_path = '/media/licode/'; // default value: undefined
